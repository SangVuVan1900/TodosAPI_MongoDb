...
var child, children, clone, compile, compileHeaders, compileOrigin, compileParameters, compilePathOrigin, compileRequest, compileResponse, compileUri, content, detectTransactionExamples, expandUriTemplateWithParameters, parent, ref, validateParameters,
...
compileOrigin = function(filename, parseResult, httpTransaction) {
  var api, exampleName, httpRequest, ref1, ref2, ref3, ref4, ref5, resource, resourceGroup, transition;
...
compilePathOrigin = function(filename, parseResult, httpTransaction) {
