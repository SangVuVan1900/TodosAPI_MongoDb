...
Validatable = (function() {
  ...
  Validatable.prototype.setBodyRealType = function() {
    var contentType, error, error1, error2, message, ref;
  ...
  Validatable.prototype.setBodyExpectedType = function() {
    var base, error, error1, error2, error3, expectedContentType, message, parsed, ref;
  ...
  Validatable.prototype.runBodyValidator = function() {
    var error, error1, expected, message, real, results, validator, validatorClass;
